...
if __name__ == "__main__":
    # Try to load existing schedules from CSV
    people_list = load_schedules_from_csv("schedules.csv")

    # If no schedules loaded, create sample data
    if not people_list:
        ...
        # Save to CSV
        save_schedules_to_csv(people_list, "schedules.csv")
    ...
    # Save common free times to CSV
    save_common_free_times_to_csv(people_list, days, "common_free_times.csv")

    # Example: Add a new course to Mo's schedule
    print("\nAdding new course to Mo's schedule...")
    if people_list:
        coursez = [TimeSlot("11:00", "12:00", "wednesday")]
        people_list[0].schedule.append(coursez)  # Add to first person (mo)
        people_list[0].busy_time = people_list[
            0
        ]._create_busy_time_dict()  # Update busy_time
        ...
        # Save updated common free times
        save_common_free_times_to_csv(people_list, days, "common_free_times.csv")
